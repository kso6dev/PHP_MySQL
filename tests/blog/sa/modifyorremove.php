...
<html lang="fr-FR">
    ...
    ?>
        ...
        <form method="post" action="modifyorremove.php">
            <label for="author">Auteur</label>: <input type="text" id="author" name="author" value=<?php echo '"'.htmlspecialchars($rec['author']).'"'; ?>> <br>
            <label for="title">Titre</label>: <input type="text" id="title" name="title" value=<?php echo '"'.htmlspecialchars($rec['title']).'"'; ?>> <br>
            <textarea name="content" id="content" cols="100" rows="20">
            <?php echo '"'.htmlspecialchars($rec['content']).'"'; ?>
            </textarea> <br>
