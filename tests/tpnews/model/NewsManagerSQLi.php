...
class NewsManagerSQLi extends NewsManager
{
    protected $_db;
    ...
    public function getList($start = -1, $limit = -1)
    {
        ...
        {
            $news = new News($rec);
            $new->setModification_date(new DateTime($news->modification_date()));
            $new->setCreation_date(new DateTime($news->creation_date()));
            $newsList[] = $news;
        }
        $query->closeCursor();
        return $newsList;
